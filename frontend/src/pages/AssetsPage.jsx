            ...
            return (
              <div key={item.id} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <div className="mt-3 flex gap-2">
                  ...
                  <button onClick={() => confirmDelete({ title: 'Delete asset?', itemName: body.category, onConfirm: () => deleteItem(item.id) })} className="rounded-xl bg-red-50 px-3 py-2 text-red-500"><Trash2 className="h-4 w-4" /></button>
                </div>
              </div>
            );
          })}
